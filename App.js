class App {
  constructor() {
    ...
    this.posts = JSON.parse(localStorage.getItem('posts')) || [
      ...
      },
      {
        ...
        username: 'wtf_etas',
        time: '2d Ago',
        image: 'https://images.unsplash.com/photo-1519125323398-675f1f1d1f1f',
        likes: '420',
    ...
    this.$rightProfileImage = document.getElementById('right-profile-image');
  ...
  updateProfileUI() {
    ...
    this.$rightProfileImage.src = this.user.photoURL;
